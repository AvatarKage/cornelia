import { hexToHsl, hslToHex } from "../common/scripts/convert.js";
import { adjustColor, updateStops, updateColor, darkenColor } from "../common/scripts/colorManagement.js";
import addTextElement from "../common/scripts/addTextElement.js";
import createOverlayGradient from "../common/scripts/createOverlayGradient.js";
...
async function injectFont(svgDoc) {
    const base64Font = await loadFont("./src/common/assets/fonts/jetbrains/nerdfont.ttf");
...
async function fetchSVG(style, variant) {
    const res = await fetch(`./src/common/assets/svg/${style}/${variant}.svg`);
