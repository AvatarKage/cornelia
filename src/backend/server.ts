...
import log from "../common/packages/avatarkage-utilities/logging/index.js";
import { toMs } from "../common/packages/avatarkage-utilities/formatting/index.js";
import Snowflake from "../common/packages/avatarkage-utilities/snowflake/index.js";
import path from "path";
import fs from "fs";
// @ts-ignore
import generateFolder from "./scripts/generateFolder.js";
import scanDir from "./scripts/scanDir.js";
import shouldWatch from "./scripts/shouldWatch.js";
...
export const svgFont = fs.readFileSync(
    path.join(config.folders.assets, "fonts", "jetbrains", "nerdfont.ttf")
).toString("base64");
...
server.use("/resources", express.static(config.folders.assets));
