import { hexToHsl, hslToHex } from "./assets/scripts/convert.js";
import { adjustColor, updateStops, updateColor, darkenColor } from "./assets/scripts/colorManagement.js";
import addTextElement from "./assets/scripts/addTextElement.js";
import createOverlayGradient from "./assets/scripts/createOverlayGradient.js";
...
async function injectFont(svgDoc) {
    const base64Font = await loadFont("./src/assets/fonts/jetbrains/nerdfont.ttf");
...
async function fetchSVG(style, variant) {
    const res = await fetch(`./src/assets/svg/${style}/${variant}.svg`);
