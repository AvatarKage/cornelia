...
import { toMs } from "./packages/avatarkage-utilities/formatting/index.ts";
import Snowflake from "./packages/avatarkage-utilities/snowflake/index.ts";
import path from "path";
import fs from "fs";
// @ts-ignore
import generateFolder from "../../src/assets/scripts/generateFolder.js";
import scanDir from "./scripts/scanDir.ts";
import shouldWatch from "./scripts/shouldWatch.ts";
