...
DefaultGroupName=Cornelia Studio
DisableWelcomePage=no
DisableDirPage=no
DisableProgramGroupPage=no
OutputDir=dist
OutputBaseFilename=Cornelia_Studio_1.1.2-beta_Installer
Compression=lzma
...
VersionInfoTextVersion=1.1.2-beta
VersionInfoProductVersion=1.1.2
VersionInfoCompany=AvatarKage
VersionInfoDescription=Create fully customizable desktop folders icons with precise control over colors, layout, and style. Choose from thousands of designs, add custom text or images, and adjust tabs, fonts, and effects.
...
[Files]
Source: "src-tauri\target\x86_64-pc-windows-msvc\release\studio.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "src\config.toml"; DestDir: "{app}";
Source: "src\icon.ico"; DestDir: "{app}";
Source: "src\userdata\*"; DestDir: "{app}\userdata"; Flags: recursesubdirs createallsubdirs;

[Icons]
Name: "{group}\Cornelia Studio"; Filename: "{app}\studio.exe";
Name: "{commondesktop}\Cornelia Studio"; Filename: "{app}\studio.exe"; Tasks: desktopicon;

[Tasks]
Name: "desktopicon"; Description: "Create a &desktop shortcut"; GroupDescription: "Additional icons:"; Flags: unchecked

[Run]
Filename: "{app}\studio.exe"; Description: "Launch Cornelia Studio"; Flags: nowait postinstall skipifsilent
